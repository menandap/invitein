                                ...
                                <div class="row">
                                    <div class="col-lg-4">
                                        <div class="form-group">
                                            ...
                                            <textarea class="form-control" name="desc_wedding" id="" rows="14" placeholder="Masukkan Deskripsi Undangan"></textarea>
                                        </div>
                                    </div>
                                    <div class="col-lg-4">
                                        <div class="form-group">
                                            <label class="form-control-label">Deskripsi Pengantin Pria</label>
                                            <textarea class="form-control" name="desc_person_1" id="" rows="14" placeholder="Masukkan Deskripsi"></textarea>
                                        </div>
                                    </div>
                                    <div class="col-lg-4">
                                        <div class="form-group">
                                            <label class="form-control-label">Deskripsi Pengantin Wanita</label>
                                            <textarea class="form-control" name="desc_person_2" id="" rows="14" placeholder="Masukkan Deskripsi"></textarea>
                                        </div>
                                    </div>
                                    <div class="col-lg-6">
